...
App de exemplo da UQBITZ: **React 19 + Vite**, saída estática, publicado pela CLI.
...
```bash
uqbitz sites create --name example-react-vite --editor developer --has-data no --has-code yes --code-runtime static
uqbitz git link <projeto> --repo UQBITZ/example-react-vite
